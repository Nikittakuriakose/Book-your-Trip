...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trime: true,
      maxlength: [40, 'A tour name should less than or equal to 40 characters'],
      minlength: [
        5,
        'A tour name should be greater than or equal to 5 characters',
      ],
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          //only for new doc creation not for updation
